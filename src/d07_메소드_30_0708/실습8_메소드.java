...
//2. main 함수에서 Printer 객체를 생성하고, printMessage 메소드를 호출하세요.
        Printer pinter1 = new Printer(); // 객체 생성
        pinter1.printMessage();
...
//2. main 함수에서 SimpleCalculator 객체를 생성하고, add 메소드를 호출하여 반환된 결과를 변수에 저장한 뒤, 그 변수를 출력하세요.
        ...
        SimpleCalculator simpleCal = new SimpleCalculator(); // 객체 생성
        int result = simpleCal.add(10, 23);
...
//2. main 함수에서 isEven 메소드를 호출하고, 반환된 값에 따라 "짝수입니다." 또는 "홀수입니다."를 출력하세요.
        Checker checker1 = new Checker(); // 객체 생성
        boolean result2 = checker1.isEven( 3 );
        if( result2 ){
...
//2. main 함수에서 Product 객체를 생성하고 초기 재고를 10으로 설정한 뒤, sell 메소드를 호출하여 구매를 시도하고 결과를 확인하세요.
        ...
        product.stock = 10;
//        product.sell( 15 );
        boolean result4 = product.sell( 15 );
