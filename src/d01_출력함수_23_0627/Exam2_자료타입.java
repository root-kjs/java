...
public class Exam2_자료타입 { // class start : 모든 자바코드는 클래스안에 작성한다.
    ...
    public static void main(String[] args) { // main start
        ...
        boolean bool1 = true;   // 리터럴 true를 저장 가능한 타입 boolean boolean boolean boolean 
        boolean bool2 = false;
        // boolean bool3 = 3;           // 3 라는 리터럴은 boolean에 저장 불가능.
        System.out.println( bool1 );    // 변수명을 호출하여 변수값 출력
        System.out.println( bool2 );

        // 2. char 타입 : '작은따옴표 으로 감싼 문자1개 저장 char char '' 1 개
        char ch1 = 'A';
        //char ch2 = 'ABC';     // 불가능. 문자열(문자여러개)
        //char ch3 = "ABC";     // " " 감싼 자료 는 불가능
        System.out.println( ch1 );

        // 3. String 클래스타입 : "큰따옴표 으로 감싼 문자 여러개 저장; String String
        String str1 = "ABC";
