...
//지시: int 타입의 변수 age를 선언하고, 자신의 임의의 나이를 리터럴로 대입한 뒤, 변수 age를 출력해 보세요.
        ...
        // System.out.println( int age = 10; ); 함수안에 변수선언은 안돼요~
...
//좌우명: String 타입의 motto
        // int : 저장공간 크기(상자), 메모리 공간! , age : 공간이름(이름표) , = 대입 , 40(리터럴/자료)
        // 초기화란: 변수선언과 동시에 값 대입!!!
        String name = "김진숙"; // 위에 변수 선언되어 있어서 에러나니 main 안에서는 변수 중복 확인 할 것!
        int age = 20 ;
...
//예시: 제 이름은 홍길동, 나이는 25세, 키는 175.5cm 입니다.  // + 연결 연산자
...
//문제6: 아래와 같이 이스케이프 문자를 이용하여 콘솔에 출력하는 코드를 작성하시오. 이스케이프 : 제어문자
//   |\_/|
//   |q p|   /}
//   ( 0 )"""\
//   |"^"`    |
...
//============================
        ...
        System.out.printf( "번호\t\t작성자\t방문록\n" ); // ]\t : 들여쓰기 거의 간격 비슷하지만 다를수 있음!
        System.out.printf( "%d\t\t%s\t%s\n", num2 , writer2 , content );
        System.out.printf( "============================\n" );
