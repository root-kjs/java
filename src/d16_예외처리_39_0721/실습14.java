...
//int result = 10 / 0;
    try {
        ...
        System.out.println("[예외발생 1] 0으로 나눌 수 없습니다.\n" + e);
    }
...
//int value = Integer.parseInt(notANumber);
    ...
    try {
        ...
        System.out.println("[예외발생 2] 잘못된 숫자 형식입니다\n" + e);
    }
...
//System.out.println(fruits[2]);
    ...
    try {
        ...
        System.out.println("[예외발생3]잘못된 인덱스에 접근했습니다." + e);
    }
...
//System.out.println("글자 수: " + text.toUpperCase());
    try {
        ...
        System.out.println("[예외발생4] 객체가 초기화되지 않았습니다." + e);
    }
...
//int result = 5 / 0;
        ...
        try {
            ...
            System.out.println("[예외발생 1] 객체가 초기화 되지 않았습니다."+ e1);
        }catch ( ArithmeticException e2){
            System.out.println("[예외발생 2] 0으로 나눌 수 없습니다. "+ e2);
        }
...
//System.out.println(arr[5]);
        ...
        try{
            ...
            System.out.println("[예외발생] 알 수 없는 오류가 발생했습니다." + e );
        }
